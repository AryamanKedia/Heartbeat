...
def predict_with_all_models(file_paths, features, models, regression_models, classes=["artifact", "murmur", "normal"]):
    """
...
def predict_with_models_combined(file_paths, features, classification_model, regression_model, model_name, classes=["artifact", "murmur", "normal"]):
    """
...
label_encoder.classes_ = np.array(['normal', 'murmur', 'artifact',])  # Original class names
